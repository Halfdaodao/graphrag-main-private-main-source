...
Use only the provided community reports and graph data to decide whether more information about entities mentioned in the report is needed. Do not use general knowledge to introduce entities, procedures, or assumptions that are not present in the provided data.
